...
# C1_ExclusionMap.tif
# C2_MeanSlope_r000.tif
# C2_MeanSlope_r180.tif
# C2_MeanSlope.tif
...
mkdir C2_MeanSlope C3_MeanSlopeExcl D4_HiProtExcl M3_LandabilityMap M4_FinalMeasurability X1_MeasurabilityMap
# 1.1) Create subdirectory for main base maps
mkdir BaseMaps

# 2) For each subset, we move the corresponding rotation specific images
mv C2_MeanSlope_r* C2_MeanSlope/
...
ffmpeg -pattern_type glob -i 'C2_MeanSlope/*.png' C2_MeanSlope.gif
